<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:00
         compiled from "/home/site/wwwroot/admin/themes/default/template/controllers/products/virtualproduct.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20238491875cf558dc4e41a4-41792121%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b3018d75c08db52838558b5ab8248509d4bd5c89' => 
    array (
      0 => '/home/site/wwwroot/admin/themes/default/template/controllers/products/virtualproduct.tpl',
      1 => 1559581726,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20238491875cf558dc4e41a4-41792121',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558dc93b923_67318223',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558dc93b923_67318223')) {function content_5cf558dc93b923_67318223($_smarty_tpl) {?>
...
" />
	...
	<div id="virtual_good" class="form-group">
		<div class="form-group">
			...
			<div class="col-lg-2">
                ...
                <?php if ($_smarty_tpl->tpl_vars['product']->value->productDownload->id) {?>
                    <p class="help-block"><?php echo smartyTranslate(array('s'=>'Turning this off also removes related data and the downloadable file.'),$_smarty_tpl);?>
</p>
                <?php }?>
			</div>
		</div>
		<div id="is_virtual_file_product"<?php if (!$_smarty_tpl->tpl_vars['product']->value->productDownload->id) {?> style="display:none;"<?php }?>>
            <hr>
            <div class="form-group">
                <label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Is this file active?'),$_smarty_tpl);?>
</label>
                <div class="col-lg-2">
                    <span class="switch prestashop-switch fixed-width-lg">
                        ...
                        <label for="virtual_product_active_on"><?php echo smartyTranslate(array('s'=>'Yes'),$_smarty_tpl);?>
</label>
                        ...
                        <label for="virtual_product_active_off"><?php echo smartyTranslate(array('s'=>'No'),$_smarty_tpl);?>
</label>
                        <a class="slide-button btn"></a>
                    </span>
                    <p class="help-block"><?php echo smartyTranslate(array('s'=>'Deactivating the download makes it inaccessible to customers, but keeps related data and the file on disk.'),$_smarty_tpl);?>
</p>
                </div>
            </div>
...
" class="" size="6" />
				...
				<div class="form-group">
					<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Expiration date'),$_smarty_tpl);?>
</label>
					<div class="col-lg-5">
