<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:26:32
         compiled from "/home/site/wwwroot/themes/community-theme-default/modules/blockcart/blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4658685915cf55848e33b95-10673203%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8886d5f5ee124f2c8ae2ba04269871adf39c3db9' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/modules/blockcart/blockcart-json.tpl',
      1 => 1559580862,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4658685915cf55848e33b95-10673203',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf55848ebe5a8_80273073',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf55848ebe5a8_80273073')) {function content_5cf55848ebe5a8_80273073($_smarty_tpl) {?>{
"products": [
...
,
    "image": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'home_default',null,ImageManager::retinaSupport()));?>
,
    "image_cart": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'cart_default',null,ImageManager::retinaSupport()));?>
,
...
,
            "truncatedValue": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(Tools::nl2br(smarty_modifier_truncate($_smarty_tpl->tpl_vars['data']->value['value'],28,'...')));?>
...
,
  "name": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(smarty_modifier_truncate(trim($_smarty_tpl->tpl_vars['discount']->value['name']),18,'...'));?>
,
...
,
  "nameDescription": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(smarty_modifier_truncate(trim((($_smarty_tpl->tpl_vars['discount']->value['name']).(' : ')).($_smarty_tpl->tpl_vars['discount']->value['description'])),18,'...'));?>
,
