<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:26:31
         compiled from "/home/site/wwwroot/themes/community-theme-default/guest-tracking.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20473572405cf558478ca404-34988363%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ef1cb54290ea1eca3046ad76fb7cf3cae3471881' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/guest-tracking.tpl',
      1 => 1559580413,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20473572405cf558478ca404-34988363',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf55847911e35_52561660',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf55847911e35_52561660')) {function content_5cf55847911e35_52561660($_smarty_tpl) {?><?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php echo smartyTranslate(array('s'=>'Guest Tracking'),$_smarty_tpl);?>
...
?>
  ...
  <?php if (isset($_smarty_tpl->tpl_vars['transformSuccess']->value)) {?>
    <div class="alert alert-success"><?php echo smartyTranslate(array('s'=>'Your guest account has been successfully transformed into a customer account. You can now log in as a registered shopper. '),$_smarty_tpl);?>
...
#guestToCustomer" class="std">
      <fieldset class="description_box box">
        ...
        <p><strong><?php echo smartyTranslate(array('s'=>'Transform your guest account into a customer account and enjoy:'),$_smarty_tpl);?>
</strong></p>
        <ul>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
            <div class="text form-group">
              <label for="guest-order-password"><strong><?php echo smartyTranslate(array('s'=>'Set your password:'),$_smarty_tpl);?>
</strong></label>
...
" class="std" id="guestTracking">
    <fieldset class="description_box box">
      ...
      <div class="text form-group">
        <label for="guest-order-reference"><?php echo smartyTranslate(array('s'=>'Order Reference:'),$_smarty_tpl);?>
 </label>
        <input id="guest-order-reference" class="form-control" type="text" name="order_reference" value="<?php if (isset($_GET['id_order'])) {?><?php echo htmlspecialchars($_GET['id_order'], ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?><?php if (isset($_POST['id_order'])) {?><?php echo htmlspecialchars($_POST['id_order'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?><?php }?>" size="8" required>
        <p class="help-block"><?php echo smartyTranslate(array('s'=>'For example: QIIXJXNUI or QIIXJXNUI#1'),$_smarty_tpl);?>
</p>
      </div>
      <div class="text form-group">
        <label for="guest-order-email"><?php echo smartyTranslate(array('s'=>'Email:'),$_smarty_tpl);?>
</label>
        <input id="guest-order-email" class="form-control" type="email" name="email" value="<?php if (isset($_GET['email'])) {?><?php echo htmlspecialchars($_GET['email'], ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?><?php if (isset($_POST['email'])) {?><?php echo htmlspecialchars($_POST['email'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?><?php }?>" required>
      </div>
      <p>
