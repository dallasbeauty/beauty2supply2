<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:01
         compiled from "/home/site/wwwroot/themes/community-theme-default/modules/referralprogram/views/templates/front/program.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15992380175cf558dd5f3162-48144327%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6adf169238b6a3458d08c4dd7e3902540f089f75' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/modules/referralprogram/views/templates/front/program.tpl',
      1 => 1559582121,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15992380175cf558dd5f3162-48144327',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558dd6f2469_71369402',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558dd6f2469_71369402')) {function content_5cf558dd6f2469_71369402($_smarty_tpl) {?><?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), ENT_QUOTES, 'UTF-8', true);?>
...
" class="std">
        <table class="table table-bordered">
          ...
          <tr>
            <th>&nbsp;</th>
            <th><?php echo smartyTranslate(array('s'=>'Last name','mod'=>'referralprogram'),$_smarty_tpl);?>
</th>
            <th><?php echo smartyTranslate(array('s'=>'First name','mod'=>'referralprogram'),$_smarty_tpl);?>
</th>
            <th><?php echo smartyTranslate(array('s'=>'E-mail','mod'=>'referralprogram'),$_smarty_tpl);?>
</th>
          </tr>
          </thead>
          <tbody>
...
<?php }?>"></td>
        ...
        <div class="checkbox">
          <label for="conditionsValided">
            ...
            <?php echo smartyTranslate(array('s'=>'I agree to the terms of service and adhere to them unconditionally.','mod'=>'referralprogram'),$_smarty_tpl);?>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'the default e-mail','mod'=>'referralprogram'),$_smarty_tpl);?>
        ...
        <div class="submit">
          <button type="submit" id="submitSponsorFriends" name="submitSponsorFriends" class="btn btn-lg btn-success"><span><?php echo smartyTranslate(array('s'=>'Validate','mod'=>'referralprogram'),$_smarty_tpl);?>
...
" class="std">
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <th><b><?php echo smartyTranslate(array('s'=>'Last invitation','mod'=>'referralprogram'),$_smarty_tpl);?>
</b></th>
          </tr>
          </thead>
          <tbody>
...
?>
        ...
        <div class="submit">
          <button type="submit" name="revive" id="revive" class="btn btn-primary"><?php echo smartyTranslate(array('s'=>'Remind my friend(s)','mod'=>'referralprogram'),$_smarty_tpl);?>
</button>
        </div>
      </form>
    <?php } else { ?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['subscribeFriends']->value&&count($_smarty_tpl->tpl_vars['subscribeFriends']->value)>0) {?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <th><?php echo smartyTranslate(array('s'=>'Inscription date','mod'=>'referralprogram'),$_smarty_tpl);?>
</th>
        </tr>
        </thead>
        <tbody>
...
">
        <?php if ($_smarty_tpl->tpl_vars['isRtl']->value) {?>&rarr;<?php } else { ?>&larr;<?php }?> <?php echo smartyTranslate(array('s'=>'Back to your account','mod'=>'referralprogram'),$_smarty_tpl);?>
