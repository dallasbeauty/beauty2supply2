<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:07
         compiled from "/home/site/wwwroot/themes/community-theme-default/scenes.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3862555515cf558e3d33a90-93334903%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb0149e42707ebab4fc4f5434f7eecaf72332f3c' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/scenes.tpl',
      1 => 1559580416,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3862555515cf558e3d33a90-93334903',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558e3e1ab46_28392937',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558e3e1ab46_28392937')) {function content_5cf558e3e1ab46_28392937($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/site/wwwroot/vendor/smarty/smarty/libs/plugins/function.math.php';
...
-scene_default.jpg); height:<?php echo intval($_smarty_tpl->tpl_vars['largeSceneImageType']->value['height']);?>
px; width:<?php echo intval($_smarty_tpl->tpl_vars['largeSceneImageType']->value['width']);?>
              ...
              <div class="product-image-container">
                <?php if (isset($_smarty_tpl->tpl_vars['imageIds']->value)) {?>
                  <?php if (!empty($_smarty_tpl->tpl_vars['lazy_load']->value)) {?>
                    <noscript>
                      <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['id_product'],$_smarty_tpl->tpl_vars['imageIds']->value,'home_default',null,ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
"
                           alt=""
...
<?php echo intval(ob_get_clean())?>"
                           height="<?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getWidthSize'][0][0]->getWidth(array('type'=>'home_default'),$_smarty_tpl);?>
<?php echo intval(ob_get_clean())?>"
                      >
                    </noscript>
                  <?php }?>
                  <picture class="img-responsive<?php if (!empty($_smarty_tpl->tpl_vars['lazy_load']->value)) {?> tb-lazy-image<?php }?>">
                    ...
                    <?php if (!empty($_smarty_tpl->tpl_vars['webp']->value)) {?>
                      <source <?php if (!empty($_smarty_tpl->tpl_vars['lazy_load']->value)) {?>srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII= 1w" data-<?php }?>srcset="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['id_product'],$_smarty_tpl->tpl_vars['imageIds']->value,'home_default','webp',ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
"
                              type="image/webp"
                      >
                    <?php }?>
                    <!--[if IE 9]></video><![endif]-->
                    <img <?php if (!empty($_smarty_tpl->tpl_vars['lazy_load']->value)) {?>srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII= 1w" data-<?php }?>srcset="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['id_product'],$_smarty_tpl->tpl_vars['imageIds']->value,'home_default',null,ImageManager::retinaSupport()), ENT_QUOTES, 'UTF-8', true);?>
"
...
<?php echo intval(ob_get_clean())?>"
              ...
              <p class="product-name"><span class="product_name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['details']->name, ENT_QUOTES, 'UTF-8', true);?>
</span></p>
              <div class="description"><?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value['details']->description_short),170,'...');?>
</div>
              <?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&$_smarty_tpl->tpl_vars['product']->value['details']->show_price) {?>
                <div class="prices">
                  <?php if (isset($_smarty_tpl->tpl_vars['product']->value['details']->online_only)&&$_smarty_tpl->tpl_vars['product']->value['details']->online_only) {?>
                    <span class="product-label product-label-online"><?php echo smartyTranslate(array('s'=>'Online only'),$_smarty_tpl);?>
</span>
                  <?php }?>
                  <?php if (isset($_smarty_tpl->tpl_vars['product']->value['details']->new)&&$_smarty_tpl->tpl_vars['product']->value['details']->new) {?>
