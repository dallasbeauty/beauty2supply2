<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:08
         compiled from "/home/site/wwwroot/themes/community-theme-default/shopping-cart-advanced.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1087899355cf558e40c1185-65290158%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '470028e8e28163937a72b27c3a204f1e50ae8b76' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/shopping-cart-advanced.tpl',
      1 => 1559580416,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1087899355cf558e40c1185-65290158',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558e4306118_94578452',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558e4306118_94578452')) {function content_5cf558e4306118_94578452($_smarty_tpl) {?><h2><?php echo smartyTranslate(array('s'=>'Cart Summary'),$_smarty_tpl);?>
</h2>
<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['total_discounts']->value!=0) {?><?php echo "1";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp47=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['total_discounts_num'] = new Smarty_variable($_tmp47, null, 0);?>
<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value) {?><?php echo "2";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp48=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['use_show_taxes'] = new Smarty_variable($_tmp48, null, 0);?>
<?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['total_wrapping']->value!=0) {?><?php echo "1";?><?php } else { ?><?php echo "0";?><?php }?><?php $_tmp49=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['total_wrapping_taxes_num'] = new Smarty_variable($_tmp49, null, 0);?>
...
" class="cart_total text-right"><?php echo smartyTranslate(array('s'=>'Total'),$_smarty_tpl);?>
</th>
    </tr>
    </thead>
    <tfoot>
...
" class="total_price_container text-right">
    ...
    <?php echo smartyHook(array('h'=>"displayAfterShoppingCartBlock",'colspan_total'=>$_smarty_tpl->tpl_vars['col_span_total']->value),$_smarty_tpl);?>
...
?>
        <?php if (floatval($_smarty_tpl->tpl_vars['discount']->value['value_real'])==0) {?>
          <?php continue 1?>
        <?php }?>
...
" class="btn btn-lg btn-default">
  ...
  <button data-show-if-js="" style="" id="confirmOrder" type="button" class="btn btn-lg btn-success pull-right standard-checkout"><span><?php echo smartyTranslate(array('s'=>'Order With Obligation To Pay'),$_smarty_tpl);?>
</span></button>
</p>
