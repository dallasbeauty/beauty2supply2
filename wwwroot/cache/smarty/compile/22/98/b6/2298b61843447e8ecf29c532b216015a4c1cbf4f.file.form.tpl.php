<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:26:29
         compiled from "/home/site/wwwroot/admin/themes/default/template/controllers/access/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15065983255cf55845346754-74633128%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2298b61843447e8ecf29c532b216015a4c1cbf4f' => 
    array (
      0 => '/home/site/wwwroot/admin/themes/default/template/controllers/access/helpers/form/form.tpl',
      1 => 1559582170,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15065983255cf55845346754-74633128',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf55845528347_21177281',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf55845528347_21177281')) {function content_5cf55845528347_21177281($_smarty_tpl) {?>
...
">
                                    <td<?php if (!$_smarty_tpl->tpl_vars['is_child']->value) {?> class="bold"<?php }?>><?php if ($_smarty_tpl->tpl_vars['is_child']->value) {?> &raquo; <?php }?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['child']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</td>
                                    <?php  $_smarty_tpl->tpl_vars['perm'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['perm']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['perms']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['perm']->key => $_smarty_tpl->tpl_vars['perm']->value) {
...
?>
                        <tr>
                          ...
                          <td>
                            <input type="checkbox"
                                   value="1"<?php if ($_smarty_tpl->tpl_vars['module']->value['view']==true) {?> checked="checked"<?php }?><?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> class="ajax-ma-view changeModuleAccess" data-rel="<?php echo intval($_smarty_tpl->tpl_vars['module']->value['id_module']);?>
||view||<?php echo intval($_smarty_tpl->tpl_vars['profile']->value['id_profile']);?>
"<?php } else { ?> class="ajax-ma-view" disabled="disabled"<?php }?>/>
                          </td>
                          <td>
                            <input type="checkbox"
                                   value="1"<?php if ($_smarty_tpl->tpl_vars['module']->value['configure']==true) {?> checked="checked"<?php }?><?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> class="ajax-ma-configure changeModuleAccess" data-rel="<?php echo intval($_smarty_tpl->tpl_vars['module']->value['id_module']);?>
...
"<?php } else { ?> class="ajax-ma-configure" disabled="disabled"<?php }?>/>
                          ...
                          <td>
                            <input type="checkbox"
                                   value="1"<?php if ($_smarty_tpl->tpl_vars['module']->value['uninstall']==true) {?> checked="checked"<?php }?><?php if ($_smarty_tpl->tpl_vars['access_edit']->value==1) {?> class="ajax-ma-uninstall changeModuleAccess" data-rel="<?php echo intval($_smarty_tpl->tpl_vars['module']->value['id_module']);?>
