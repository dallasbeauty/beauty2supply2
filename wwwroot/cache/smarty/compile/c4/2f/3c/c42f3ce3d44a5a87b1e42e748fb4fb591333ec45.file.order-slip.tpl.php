<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:05
         compiled from "/home/site/wwwroot/themes/community-theme-default/order-slip.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1607464545cf558e1bcaef6-16800217%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c42f3ce3d44a5a87b1e42e748fb4fb591333ec45' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/order-slip.tpl',
      1 => 1559580415,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1607464545cf558e1bcaef6-16800217',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558e1c27c20_65807620',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558e1c27c20_65807620')) {function content_5cf558e1c27c20_65807620($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/site/wwwroot/vendor/smarty/smarty/libs/plugins/modifier.regex_replace.php';
...
<p>
  <b><?php echo smartyTranslate(array('s'=>'Credit slips you have received after canceled orders'),$_smarty_tpl);?>
.</b>
</p>
<div class="block-center" id="block-history">
  <?php if ($_smarty_tpl->tpl_vars['ordersSlip']->value&&count($_smarty_tpl->tpl_vars['ordersSlip']->value)) {?>
    <table id="order-list" class="table table-bordered footab">
      <thead>
      <tr>
        <th data-sort-ignore="true"><?php echo smartyTranslate(array('s'=>'Credit slip'),$_smarty_tpl);?>
</th>
        <th data-sort-ignore="true"><?php echo smartyTranslate(array('s'=>'Order'),$_smarty_tpl);?>
</th>
        <th><?php echo smartyTranslate(array('s'=>'Date issued'),$_smarty_tpl);?>
</th>
        <th data-sort-ignore="true" data-hide="phone"><?php echo smartyTranslate(array('s'=>'View credit slip'),$_smarty_tpl);?>
</th>
      </tr>
      </thead>
      <tbody>
...
">
          ...
          <td class="history_invoice">
            <a class="btn btn-default" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['slip']->value['id_order_slip']);?>
<?php $_tmp37=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('pdf-order-slip',true,null,"id_order_slip=".$_tmp37), ENT_QUOTES, 'UTF-8', true);?>
...
">
  ...
  <?php } else { ?>
    <div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'You have not received any credit slips.'),$_smarty_tpl);?>
</div>
  <?php }?>
</div>
