<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:08
         compiled from "/home/site/wwwroot/themes/community-theme-default/stores.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12875948855cf558e4eb2e86-34973075%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dec558aedfa080ef38e946031d0c595e641046e3' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/stores.tpl',
      1 => 1559580416,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12875948855cf558e4eb2e86-34973075',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558e500fe48_94768942',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558e500fe48_94768942')) {function content_5cf558e500fe48_94768942($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/site/wwwroot/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
...
<h1 class="page-heading"><?php echo smartyTranslate(array('s'=>'Our stores'),$_smarty_tpl);?>
</h1>
...
-medium_default.jpg"
                     alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['store']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
"
                     style="width: <?php echo $_smarty_tpl->tpl_vars['mediumSize']->value['width'];?>
...
<?php } else { ?>
  ...
  <p>
    <b><?php echo smartyTranslate(array('s'=>'Enter a location (e.g. zip/postal code, address, city or country) in order to find the nearest stores.'),$_smarty_tpl);?>
</b>
  </p>
  ...
  <div class="store-content form-inline">
    ...
    <div class="form-group">
      ...
      <input class="form-control" type="text" name="location" id="addressInput" value="<?php echo smartyTranslate(array('s'=>'Address, zip / postal code, city, state or country'),$_smarty_tpl);?>
">
    </div>
