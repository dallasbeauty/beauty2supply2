<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:04
         compiled from "/home/site/wwwroot/themes/community-theme-default/order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17947381675cf558e00bce11-70908690%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f434fda64be990ef8909b3b1b193e8b197ee21a1' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/order-detail.tpl',
      1 => 1559580414,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17947381675cf558e00bce11-70908690',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558e059c045_86804982',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558e059c045_86804982')) {function content_5cf558e059c045_86804982($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/site/wwwroot/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
...
" name="id_order">
        ...
        <a href="#" onclick="$(this).closest('form').submit(); return false;" class="btn btn-lg btn-success pull-right"><span><?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
...
</strong> <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['order']->value->payment, ENT_QUOTES, 'UTF-8', true);?>
</span></p>
...
<?php }?>"><?php echo smartyTranslate(array('s'=>'Download your invoice as a PDF file.'),$_smarty_tpl);?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['order']->value->recyclable) {?>
      <p><i class="icon icon-2x text-success icon-repeat"></i> <?php echo smartyTranslate(array('s'=>'You have given permission to receive your order in recycled packaging.'),$_smarty_tpl);?>
</p>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['order']->value->gift) {?>
      <p><i class="icon icon-2x text-success icon-gift"></i> <?php echo smartyTranslate(array('s'=>'You have requested gift wrapping for this order.'),$_smarty_tpl);?>
</p>
      <p><strong><?php echo smartyTranslate(array('s'=>'Message'),$_smarty_tpl);?>
...
" method="post"><?php }?>
  <div id="order-detail-content" class="table_block table-responsive">
    <table class="table table-bordered">
      <thead>
      <tr>
        <?php if ($_smarty_tpl->tpl_vars['return_allowed']->value) {?><th><input type="checkbox"></th><?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['order']->value->hasProductReturned()) {?>
          <th><?php echo smartyTranslate(array('s'=>'Returned'),$_smarty_tpl);?>
</th>
        <?php }?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_name'], ENT_QUOTES, 'UTF-8', true);?>
              ...
              <td>
                <input class="order_qte_input form-control text-center"  name="order_qte_input[<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['products']['index'];?>
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['discount']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
  ...
  <?php if ($_smarty_tpl->tpl_vars['return_allowed']->value) {?>
    <div id="returnOrderMessage">
      <h3 class="page-heading"><?php echo smartyTranslate(array('s'=>'Merchandise return'),$_smarty_tpl);?>
</h3>
      ...
      <div class="form-group">
        <button type="submit" name="submitReturnMerchandise" class="btn btn-success"><span><?php echo smartyTranslate(array('s'=>'Make an RMA slip'),$_smarty_tpl);?>
    ...
    <div class="table-responsive">
      <table class="table table-bordered footab">
        ...
        <tr>
          ...
          <th data-sort-ignore="true"><?php echo smartyTranslate(array('s'=>'Carrier'),$_smarty_tpl);?>
</th>
          <th data-hide="phone"><?php echo smartyTranslate(array('s'=>'Weight'),$_smarty_tpl);?>
</th>
          <th data-hide="phone"><?php echo smartyTranslate(array('s'=>'Shipping cost'),$_smarty_tpl);?>
</th>
          <th data-hide="phone" data-sort-ignore="true"><?php echo smartyTranslate(array('s'=>'Tracking number'),$_smarty_tpl);?>
</th>
        </tr>
        </thead>
        <tbody>
    ...
    <?php if (count($_smarty_tpl->tpl_vars['messages']->value)) {?>
      ...
      <div class="table_block table-responsive">
        <table class="detail_step_by_step table table-bordered">
          <thead>
          <tr>
            <th style="width:150px;"><?php echo smartyTranslate(array('s'=>'From'),$_smarty_tpl);?>
</th>
            <th><?php echo smartyTranslate(array('s'=>'Message'),$_smarty_tpl);?>
</th>
          </tr>
          </thead>
          <tbody>
...
" method="post" class="std" id="sendOrderMessage">
      <h3 class="page-heading"><?php echo smartyTranslate(array('s'=>'Add a message'),$_smarty_tpl);?>
</h3>
...
">
        <button type="submit" name="submitMessage" class="btn btn-lg btn-success"><span><?php echo smartyTranslate(array('s'=>'Send'),$_smarty_tpl);?>
 <i class="icon icon-chevron-right"></i></span></button>
      </div>
    </form>
  <?php } else { ?>
    <div class="alert alert-info"><i class="icon icon-info-sign"></i> <?php echo smartyTranslate(array('s'=>'You cannot return merchandise with a guest account'),$_smarty_tpl);?>
</div>
  <?php }?>
<?php }?>
<?php }} ?>
