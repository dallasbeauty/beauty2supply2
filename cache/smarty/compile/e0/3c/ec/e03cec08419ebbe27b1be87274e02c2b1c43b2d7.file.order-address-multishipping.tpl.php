<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:02
         compiled from "/home/site/wwwroot/themes/community-theme-default/order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4211558195cf558dec6b058-79484285%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e03cec08419ebbe27b1be87274e02c2b1c43b2d7' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/order-address-multishipping.tpl',
      1 => 1559580414,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4211558195cf558dec6b058-79484285',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558ded4eef4_53309978',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558ded4eef4_53309978')) {function content_5cf558ded4eef4_53309978($_smarty_tpl) {?><?php if (!$_smarty_tpl->tpl_vars['opc']->value) {?>
...
<?php $_tmp25=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp26=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp25.$_tmp26), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="btn btn-success"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
 <i class="icon icon-chevron-right"></i></span></a>
  ...
  <p class="address_add submit">
    <a href="<?php ob_start();?><?php echo urlencode('&multi-shipping=1');?>
<?php $_tmp27=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo urlencode($_smarty_tpl->tpl_vars['back']->value);?>
<?php }?><?php $_tmp28=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp27.$_tmp28), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="btn btn-success"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
 <i class="icon icon-chevron-right"></i></span></a>
  </p>
...
" class="btn btn-lg btn-default"><i class="icon icon-chevron-left"></i> <?php echo smartyTranslate(array('s'=>'Continue Shopping'),$_smarty_tpl);?>
</a>
      <?php } else { ?>
...
" class="btn btn-lg btn-default"><i class="icon icon-chevron-left"></i> <?php echo smartyTranslate(array('s'=>'Continue Shopping'),$_smarty_tpl);?>
      ...
      <?php }?>
      <button type="submit" name="processAddress" class="btn btn-lg btn-success pull-right"><span><?php echo smartyTranslate(array('s'=>'Proceed to checkout'),$_smarty_tpl);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array('default', null, null); ob_start(); ?><a class="btn btn-success" href="<?php echo Smarty::$_smarty_vars['capture']['addressUrlAdd'];?>
...
"><span><?php echo smartyTranslate(array('s'=>'Update','js'=>1),$_smarty_tpl);?>
 <i class="icon icon-chevron-right"></i></span></a><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
