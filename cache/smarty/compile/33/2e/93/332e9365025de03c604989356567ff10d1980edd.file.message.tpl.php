<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:26:31
         compiled from "/home/site/wwwroot/admin/themes/default/template/controllers/customer_threads/message.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1611110525cf55847b7abf1-62057323%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '332e9365025de03c604989356567ff10d1980edd' => 
    array (
      0 => '/home/site/wwwroot/admin/themes/default/template/controllers/customer_threads/message.tpl',
      1 => 1559581715,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1611110525cf55847b7abf1-62057323',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf55847c2d859_92145437',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf55847c2d859_92145437')) {function content_5cf55847c2d859_92145437($_smarty_tpl) {?>
		...
		<h3>
			<?php if (!empty($_smarty_tpl->tpl_vars['message']->value['employee_name'])) {?>
				<i><?php echo $_smarty_tpl->tpl_vars['employee_avatar']->value;?>
					 ...
					 (<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['message']->value['employee_name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
) - <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['PS_SHOP_NAME']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>

			<?php } else { ?>
				<i class="icon-user"></i> 
				<?php if (!empty($_smarty_tpl->tpl_vars['message']->value['id_customer'])) {?>
					<a href="index.php?tab=AdminCustomers&amp;id_customer=<?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_customer']);?>
...
">
						<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['message']->value['customer_name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>

					</a>
				<?php } else { ?>
					<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['idnToUtf8'][0][0]->convertEmailFromIdn($_smarty_tpl->tpl_vars['message']->value['email']), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" title="<?php echo smartyTranslate(array('s'=>'View customer'),$_smarty_tpl);?>
">
						<?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_customer']);?>
 <i class="icon-search"></i>
			...
			<dl class="dl-horizontal">			
				...
				<dd><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['message']->value['date_add'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&nbsp;</dd>
			</dl>
			...
			<dl class="dl-horizontal">
				...
				<dd><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['message']->value['user_agent'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&nbsp;</dd>
			</dl>
			<?php }?>
			...
			<dl class="dl-horizontal">
				...
				<dd>
					<a href="index.php?tab=AdminCustomerThreads&amp;id_customer_thread=<?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_customer_thread']);?>
...
&amp;filename=<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['message']->value['file_name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"
...
">
			...
			<?php if (!empty($_smarty_tpl->tpl_vars['message']->value['id_order'])&&$_smarty_tpl->tpl_vars['is_valid_order_id']->value&&empty($_smarty_tpl->tpl_vars['message']->value['id_employee'])) {?>
				<dl class="dl-horizontal">
					...
					<dd><a href="index.php?tab=AdminOrders&amp;id_order=<?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_order']);?>
...
"><?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_order']);?>
...
" /></a>
			...
			<?php if (!empty($_smarty_tpl->tpl_vars['message']->value['id_product'])&&empty($_smarty_tpl->tpl_vars['message']->value['id_employee'])) {?>
				<dl class="dl-horizontal">
					...
					<dd><a href="index.php?tab=AdminProducts&amp;id_product=<?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_product']);?>
...
" title="<?php echo smartyTranslate(array('s'=>'View order'),$_smarty_tpl);?>
"><?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_product']);?>
 <img src="../img/admin/search.gif" alt="<?php echo smartyTranslate(array('s'=>'View'),$_smarty_tpl);?>
" /></a></dd>
				</dl>
			<?php }?>
...
<?php } else { ?>
		<div class="infoEmployee">
			<?php if ($_smarty_tpl->tpl_vars['id_employee']->value) {?>
				<a class="btn btn-default pull-right" href="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['thread_url']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
">
 ...
 (<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['idnToUtf8'][0][0]->convertEmailFromIdn($_smarty_tpl->tpl_vars['message']->value['email']), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
			...
			<?php if (!empty($_smarty_tpl->tpl_vars['message']->value['id_customer'])&&empty($_smarty_tpl->tpl_vars['message']->value['id_employee'])) {?>
				<!--<dl class="dl-horizontal">
					...
					<dd><?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_customer']);?>
</dd>
				</dl>-->
			<?php }?>
			...
			<?php if (!empty($_smarty_tpl->tpl_vars['message']->value['id_order'])&&empty($_smarty_tpl->tpl_vars['message']->value['id_employee'])) {?>
				<!--<dl class="dl-horizontal">
					<dt><?php echo smartyTranslate(array('s'=>'Order #'),$_smarty_tpl);?>
:</dt>
					<dd><?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_order']);?>
</dd>
				</dl>-->
			<?php }?>
			...
			<?php if (!empty($_smarty_tpl->tpl_vars['message']->value['id_product'])&&empty($_smarty_tpl->tpl_vars['message']->value['id_employee'])) {?>
				<!--<dl class="dl-horizontal">
					<dt><?php echo smartyTranslate(array('s'=>'Product #'),$_smarty_tpl);?>
:</dt>
					<dd><?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_product']);?>
</dd>
				</dl>-->
			<?php }?>
			...
			<!--<dl class="dl-horizontal">
				...
				<dd><?php echo intval($_smarty_tpl->tpl_vars['message']->value['subject']);?>
</dd>
			</dl>-->
<?php }?>
<?php if (!$_smarty_tpl->tpl_vars['email']->value) {?>
			<dl class="dl-horizontal">
				...
				<dd><?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_customer_thread']);?>
</dd>
			</dl>
			<dl class="dl-horizontal">
				<dt><?php echo smartyTranslate(array('s'=>'Message ID:'),$_smarty_tpl);?>
</dt>
				<dd><?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_customer_message']);?>
</dd>
			</dl>
<?php }?>
			<dl class="dl-horizontal">
	...
	<?php if (empty($_smarty_tpl->tpl_vars['message']->value['id_employee'])) {?>
		<div class="panel">
			<button class="btn btn-default"
				onclick="$('#reply_to_<?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_customer_message']);?>
').show(500); $(this).parent().hide();">
	...
	<?php }?>
	<div id="reply_to_<?php echo intval($_smarty_tpl->tpl_vars['message']->value['id_customer_message']);?>
" style="display: none;">
		<div class="panel">
...
" />
					<input type="hidden" name="msg_email" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['message']->value['email'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
				</div>				
			</form>
		</div>
