<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:08
         compiled from "/home/site/wwwroot/themes/community-theme-default/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20117072465cf558e474bf85-16528240%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd13b86ec6b12e841300e8d29a65f45b97109e12e' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/shopping-cart.tpl',
      1 => 1559580416,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20117072465cf558e474bf85-16528240',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558e4ba2565_46391937',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558e4ba2565_46391937')) {function content_5cf558e4ba2565_46391937($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/site/wwwroot/vendor/smarty/smarty/libs/plugins/modifier.regex_replace.php';
...
<?php if (isset($_smarty_tpl->tpl_vars['empty']->value)) {?>
  <div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Your shopping cart is empty.'),$_smarty_tpl);?>
</div>
<?php } elseif ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
  <div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'This store has not accepted your new order.'),$_smarty_tpl);?>
</div>
<?php } else { ?>
  <div id="emptyCartWarning" class="alert alert-warning unvisible"><?php echo smartyTranslate(array('s'=>'Your shopping cart is empty.'),$_smarty_tpl);?>
</div>
  ...
  <?php echo smartyHook(array('h'=>"displayBeforeShoppingCartBlock"),$_smarty_tpl);?>
  ...
  <div id="order-detail-content" class="table_block table-responsive">
    <table id="cart_summary" class="table table-bordered <?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?>stock-management-on<?php } else { ?>stock-management-off<?php }?>">
      ...
      <tr>
        ...
        <th class="cart_description"><?php echo smartyTranslate(array('s'=>'Description'),$_smarty_tpl);?>
</th>
        <?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?>
          ...
          <th class="cart_avail text-center"><?php echo smartyTranslate(array('s'=>'Availability'),$_smarty_tpl);?>
</th>
        <?php } else { ?>
          <?php $_smarty_tpl->tpl_vars['col_span_subtotal'] = new Smarty_variable('2', null, 0);?>
        <?php }?>
        <th class="cart_unit text-right"><?php echo smartyTranslate(array('s'=>'Unit price'),$_smarty_tpl);?>
</th>
        <th class="cart_quantity text-center"><?php echo smartyTranslate(array('s'=>'Qty'),$_smarty_tpl);?>
</th>
        <th class="cart_delete">&nbsp;</th>
        <th class="cart_total text-right"><?php echo smartyTranslate(array('s'=>'Total'),$_smarty_tpl);?>
</th>
      </tr>
      </thead>
      <tfoot>
...
<?php }?>">
                    ...
                    <button type="submit" name="submitAddDiscount" class="btn btn-primary"><span><?php echo smartyTranslate(array('s'=>'OK'),$_smarty_tpl);?>
</span></button>
                  </fieldset>
                </form>
...
" class="total_price_container text-right">
          ...
          <div class="hookDisplayProductPriceBlock-price">
            <?php echo smartyHook(array('h'=>"displayCartTotalPriceLabel"),$_smarty_tpl);?>
...
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
<?php if ($_smarty_tpl->tpl_vars['odd']->value) {?> odd<?php } else { ?> even<?php }?> customization">
              <td></td>
              <td colspan="3">
...
<?php $_tmp67=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp66."&amp;ipa=".$_tmp67."&amp;id_customization=".((string)$_smarty_tpl->tpl_vars['id_customization']->value)."&amp;id_address_delivery=".((string)$_smarty_tpl->tpl_vars['product']->value['id_address_delivery'])."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
"
                    rel="nofollow"
...
<?php }?>"
          class="btn btn-lg btn-success pull-right standard-checkout btn-full" title="<?php echo smartyTranslate(array('s'=>'Proceed to checkout'),$_smarty_tpl);?>
">
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['secureReferrer'][0][0]->secureReferrer(htmlspecialchars(smarty_modifier_regex_replace($_SERVER['HTTP_REFERER'],'/[\?|&]content_only=1/',''), ENT_QUOTES, 'UTF-8', true));?>
<?php }?>"
       class="btn btn-lg btn-default btn-full" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
">
      <i class="icon icon-chevron-left"></i> <?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
