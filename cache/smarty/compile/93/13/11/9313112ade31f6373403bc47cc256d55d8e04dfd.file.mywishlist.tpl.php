<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:26:36
         compiled from "/home/site/wwwroot/themes/community-theme-default/modules/blockwishlist/views/templates/front/mywishlist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20247726875cf5584ca501b1-91867982%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9313112ade31f6373403bc47cc256d55d8e04dfd' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/modules/blockwishlist/views/templates/front/mywishlist.tpl',
      1 => 1559582116,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20247726875cf5584ca501b1-91867982',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf5584caa65e5_84148860',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf5584caa65e5_84148860')) {function content_5cf5584caa65e5_84148860($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/site/wwwroot/vendor/smarty/smarty/libs/plugins/modifier.date_format.php';
    ...
    <?php if ($_smarty_tpl->tpl_vars['wishlists']->value) {?>
      <div id="block-history" class="block-center">
        <table class="table table-bordered">
          <thead>
          <tr>
            <th><?php echo smartyTranslate(array('s'=>'Name','mod'=>'blockwishlist'),$_smarty_tpl);?>
</th>
            <th class="mywishlist_first"><?php echo smartyTranslate(array('s'=>'Qty','mod'=>'blockwishlist'),$_smarty_tpl);?>
</th>
            <th class="mywishlist_first"><?php echo smartyTranslate(array('s'=>'Viewed','mod'=>'blockwishlist'),$_smarty_tpl);?>
</th>
            <th class="mywishlist_second"><?php echo smartyTranslate(array('s'=>'Created','mod'=>'blockwishlist'),$_smarty_tpl);?>
</th>
            <th class="mywishlist_second"><?php echo smartyTranslate(array('s'=>'Direct Link','mod'=>'blockwishlist'),$_smarty_tpl);?>
</th>
            <th class="mywishlist_second"><?php echo smartyTranslate(array('s'=>'Default','mod'=>'blockwishlist'),$_smarty_tpl);?>
</th>
            <th class="mywishlist_first"><?php echo smartyTranslate(array('s'=>'Delete','mod'=>'blockwishlist'),$_smarty_tpl);?>
</th>
          </tr>
          </thead>
          <tbody>
...
');">
                  <?php echo mb_convert_encoding(htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['wishlists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['name'],30,'...'), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
'));">
              ...
              <td class="wishlist_delete">
                <a href="#" onclick="javascript:event.preventDefault();return (WishlistDelete('wishlist_<?php echo intval($_smarty_tpl->tpl_vars['wishlists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id_wishlist']);?>
', '<?php echo intval($_smarty_tpl->tpl_vars['wishlists']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['id_wishlist']);?>
...
<nav>
  <ul class="pager">
    <li class="previous">
      <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Back to your account','mod'=>'blockwishlist'),$_smarty_tpl);?>
">
        <?php if ($_smarty_tpl->tpl_vars['isRtl']->value) {?>&rarr;<?php } else { ?>&larr;<?php }?> <?php echo smartyTranslate(array('s'=>'Back to your account','mod'=>'blockwishlist'),$_smarty_tpl);?>
