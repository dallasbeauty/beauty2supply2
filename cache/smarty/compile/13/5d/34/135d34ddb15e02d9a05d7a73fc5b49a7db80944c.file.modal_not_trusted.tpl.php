<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:26:34
         compiled from "/home/site/wwwroot/admin/themes/default/template/controllers/modules/modal_not_trusted.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4276564115cf5584a03aa74-78743528%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '135d34ddb15e02d9a05d7a73fc5b49a7db80944c' => 
    array (
      0 => '/home/site/wwwroot/admin/themes/default/template/controllers/modules/modal_not_trusted.tpl',
      1 => 1559581721,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4276564115cf5584a03aa74-78743528',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_5cf5584a04e484_78486069',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf5584a04e484_78486069')) {function content_5cf5584a04e484_78486069($_smarty_tpl) {?>

<div class="untrusted-content-action">

	<div class="modal-body">
		<div class="alert alert-warning">
			<h3><?php echo smartyTranslate(array('s'=>'Do you want to install this module that could not be verified by thirty bees?'),$_smarty_tpl);?>
</h3>
	...
	<div class="modal-footer">
		<div class="alert alert-info">
			<p>
				<?php echo smartyTranslate(array('s'=>'Since you may not have downloaded this module from thirty bees Addons, we cannot assert that the module is not adding some undisclosed functionalities. We advise you to install it only if you trust the source of the content.'),$_smarty_tpl);?>
...
<div class="untrusted-content-more-info" style="display:none;">
	...
	<div class="modal-body">
		...
		<p><?php echo smartyTranslate(array('s'=>"thirty bees, being an open-source software, has an awesome community with a long history of developing and sharing high quality modules. Before installing this module, making sure its author is a known community member is always a good idea (by checking [1]our forum[/1] for instance).",'tags'=>array('<a href="https://www.thirtybees.com/forums/">')),$_smarty_tpl);?>
</p>
		...
		<p><?php echo smartyTranslate(array('s'=>"Otherwise you can look for similar modules on the official marketplace. [1]Click here to browse thirty bees Addons[/1].",'tags'=>array('<a class="catalog-link" href="#">')),$_smarty_tpl);?>
