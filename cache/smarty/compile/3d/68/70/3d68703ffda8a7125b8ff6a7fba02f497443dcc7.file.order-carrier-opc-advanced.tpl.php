<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:03
         compiled from "/home/site/wwwroot/themes/community-theme-default/order-carrier-opc-advanced.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17436008125cf558df778689-79928001%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3d68703ffda8a7125b8ff6a7fba02f497443dcc7' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/order-carrier-opc-advanced.tpl',
      1 => 1559580414,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17436008125cf558df778689-79928001',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558df9ed018_02875588',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558df9ed018_02875588')) {function content_5cf558df9ed018_02875588($_smarty_tpl) {?><div class="order_carrier_content box">
  ...
  <?php } else { ?>
    ...
    <?php if (isset($_smarty_tpl->tpl_vars['isVirtualCart']->value)&&$_smarty_tpl->tpl_vars['isVirtualCart']->value) {?>
      <div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'No carrier is needed for this order.'),$_smarty_tpl);?>
</div>
    <?php } else { ?>
...
<?php }?><?php if (!$_smarty_tpl->tpl_vars['product']->last) {?>,&nbsp;<?php } else { ?>">&hellip;</abbr>)<?php }?><?php } else { ?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php if (isset($_smarty_tpl->tpl_vars['product']->value['attributes'])&&$_smarty_tpl->tpl_vars['product']->value['attributes']) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['attributes'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
