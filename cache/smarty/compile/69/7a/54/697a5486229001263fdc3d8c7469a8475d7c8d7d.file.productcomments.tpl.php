<?php /* Smarty version Smarty-3.1.19-dev, created on 2019-06-03 17:29:00
         compiled from "/home/site/wwwroot/themes/community-theme-default/modules/productcomments/productcomments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14772863135cf558dcc7c9a1-89003177%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '697a5486229001263fdc3d8c7469a8475d7c8d7d' => 
    array (
      0 => '/home/site/wwwroot/themes/community-theme-default/modules/productcomments/productcomments.tpl',
      1 => 1559580877,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14772863135cf558dcc7c9a1-89003177',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cf558dcd429c4_40388697',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cf558dcd429c4_40388697')) {function content_5cf558dcd429c4_40388697($_smarty_tpl) {?><div id="product_comments_block_tab">
...
?>
      <?php if (!empty($_smarty_tpl->tpl_vars['comment']->value['content'])) {?>
...
">
          ...
          <div class="comment_author col-sm-3 col-md-2">
            <div class="form-group">
              <div><b><?php echo smartyTranslate(array('s'=>'Grade','mod'=>'productcomments'),$_smarty_tpl);?>
</b></div>
...
?>
            ...
            <div class="form-group">
              <b itemprop="author"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['comment']->value['customer_name'], ENT_QUOTES, 'UTF-8', true);?>
</b>
              <p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0][0]->dateFormat(array('date'=>htmlspecialchars($_smarty_tpl->tpl_vars['comment']->value['date_add'], ENT_QUOTES, 'UTF-8', true),'full'=>0),$_smarty_tpl);?>
</p>
            </div>
          </div>
          ...
          <div class="comment_details col-sm-9 col-md-10">
            <p>
              <b itemprop="name"><?php echo $_smarty_tpl->tpl_vars['comment']->value['title'];?>
</b>
            </p>
              ...
              <?php if ($_smarty_tpl->tpl_vars['is_logged']->value) {?>
                <?php if (!$_smarty_tpl->tpl_vars['comment']->value['customer_advice']) {?>
                  <li>
                    ...
                    <button class="usefulness_btn btn btn-xs btn-link" data-is-usefull="1" data-id-product-comment="<?php echo $_smarty_tpl->tpl_vars['comment']->value['id_product_comment'];?>
">
                      <i class="icon icon-thumbs-up"></i> <?php echo smartyTranslate(array('s'=>'Yes','mod'=>'productcomments'),$_smarty_tpl);?>

                    </button>
                    <button class="usefulness_btn btn btn-xs btn-link" data-is-usefull="0" data-id-product-comment="<?php echo $_smarty_tpl->tpl_vars['comment']->value['id_product_comment'];?>
">
                      <i class="icon icon-thumbs-down"></i> <?php echo smartyTranslate(array('s'=>'No','mod'=>'productcomments'),$_smarty_tpl);?>
                ...
                <?php if (!$_smarty_tpl->tpl_vars['comment']->value['customer_report']) {?>
                  <li>
                    <a href="#" class="report_btn btn btn-xs btn-link" data-id-product-comment="<?php echo $_smarty_tpl->tpl_vars['comment']->value['id_product_comment'];?>
">
                      <i class="icon icon-flag"></i> <?php echo smartyTranslate(array('s'=>'Report abuse','mod'=>'productcomments'),$_smarty_tpl);?>
  ...
  <?php } else { ?>
    ...
    <?php } else { ?>
      <div class="form-group"><?php echo smartyTranslate(array('s'=>'No customer reviews for the moment.','mod'=>'productcomments'),$_smarty_tpl);?>
</div>
    <?php }?>
  <?php }?>
</div>
...
<div style="display: none;">
  <div id="new_comment_form">
    <form id="id_new_comment_form" action="#">
      ...
      <?php if (!empty($_smarty_tpl->tpl_vars['criterions']->value)) {?>
...
'>
        <p class="help-block">
          <sup>*</sup> <?php echo smartyTranslate(array('s'=>'Required fields','mod'=>'productcomments'),$_smarty_tpl);?>
